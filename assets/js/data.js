export const destinations = [
  {
    ...
    description: `Indonesia has a well-known volcano called Bromo. It is a
    component of the Tengger Massif, a collection of
    volcanoes. Bromo's breathtaking views are the reason why
    people adore going there. You can see a large stretch of
    sand surrounding the volcano at sunrise. Bromo can
    occasionally even emit smoke and ash, adding to its
    spectacular appearance. In order to take in the
  ...
  {
    id: "ijen_carter",
    description: ` The Ijen Crater is a big hole in Indonesia with a cool
    blue lake inside. The lake looks special because it's
    super acidic and full of sulfur, which gives it a bright
    turquoise color. Early in the morning, you can see blue
    flames flickering around the crater, like magic! People
    also come here to see how locals mine sulfur from the
  ...
  {
    id: "bondowoso_carter",
    description: `The Bondowoso Crater is a stunning natural attraction
    located in Bondowoso, East Java, Indonesia. It's known for
    its vast, barren landscape with rugged terrain and steep
    cliffs. The crater was formed by a volcanic eruption long
    ago, leaving behind a deep, bowl-shaped depression.
  ...
  {
    id: "tumpak_sewu",
    description: `Tumpak Sewu Beach, also known as Tumpak Sewu Waterfall,
    is a stunning natural attraction located in East Java,
    Indonesia. It's famous for its majestic waterfall
  ...
  {
    id: "wedi_klopo_beach",
    description: `Wedi Klopo Beach is a beautiful spot in Malang,
    Indonesia. It's famous for its soft, sandy shores
    and clear blue waters. Visitors can relax on the
    beach, swim, or even try surfing if they're feeling
    adventurous. The beach is surrounded by coconut
  ...
  {
    id: "papuma_beach",
    description: ` Papuma Beach is a stunning destination located in Jember,
    East Java, Indonesia. It's known for its pristine white
    sand, clear turquoise waters, and dramatic cliffs that
  ...
  {
    id: "de_djawatan",
    description: `De Djawatan Forest, or Taman Hutan Raya Ir. H.
    Djuanda, is a big forest park in Banyuwangi, Indonesia.
    People love it for its beautiful trees, animals, and
    great trails for walking. It's named after a famous
    Indonesian leader. You can hike, have picnics, and
  ...
  },
  {
    id: "village_bulak",
    title: "Bulak Village",
    description: `Bulak Village is a charming rural area located in
    Indonesia, known for its picturesque landscapes and
    traditional way of life. Surrounded by lush green fields
    and small streams, it offers a peaceful escape from the
  ...
  },
  {
    ...
    title: "Madaripura Waterfall",
    description: `Madakaripura Waterfall in East Java, Indonesia, is
    the tallest waterfall there. It's like a hidden gem,
    tucked among green cliffs. People love to visit
    because it's stunning! Legend has it that a famous
    warrior once meditated here. To get there, you'll
    trek through a canyon and splash through streams.
  ...
  },
  {
    ...
    Visitors can explore historical sites like the
    Singosari Temple and Jago Temple, which date back to
  ...
  {
    id: "the_coban_rondo",
    title: "The Coban Rondo",
    description: `The Coban Rondo Labyrinth is a fun and unique
    attraction located in Batu, Indonesia. It's
    essentially a maze made up of green hedges and
    pathways that twist and turn. Visitors can explore
    the labyrinth, trying to find their way out while
    enjoying the lush greenery all around them. It's a
  ...
  {
    id: "sumber_umbulan",
    title: "Sumber Umbulan",
    description: `Sumber Umbulan is a natural spring located in East
    Java, Indonesia. It's known for its crystal-clear
    water and serene surroundings. People visit Sumber
    Umbulan to relax and enjoy the refreshing water,
    which is believed to have therapeutic properties.
    The area around the spring is lush with greenery,
    making it a peaceful retreat away from the hustle
    and bustle of city life. It's a popular spot for
  ...
  },
  {
    ...
    2014. The volcano has a large crater at its summit, which
    sometimes contains a lake. Mount Kelud's eruptions often
    result in the release of volcanic ash and rocks, posing a
    risk to nearby communities. Despite its dangers, Mount
...
export const dances = [
  {
    id: "reog_ponorogo",
    title: "Reog Ponorogo",
    description: `Reog Ponorogo is a traditional performing art originating from Ponorogo, a regency in East Java, Indonesia. 
    It is characterized by its vibrant and dynamic dance performances accompanied by gamelan music. 
    The highlight of Reog Ponorogo is the impressive lion-like mask, known as "Singa Barong," which weighs up to 50 kilograms and is worn by a strong dancer who also carries it while performing acrobatic moves. 
    The performance often depicts mythical stories and folklore, with dancers showcasing their agility, strength, and skill. 
    Reog Ponorogo is not only a form of entertainment but also a symbol of cultural identity and pride for the people of Ponorogo and has gained recognition as one of Indonesia's cultural treasures.`,
    city: "Ponorogo",
    image_url:
  ...
  },
  {
    id: "tari_sangkal",
    title: "Tari Sangkal",
    description: `Tari Sangkal is a traditional dance from the Jember region of East Java, Indonesia. 
...
export const foods = [
  {
    id: "Rawon",
    title: "Rawon",
    description: `This is an East Javanese food that is characterized by black soup. 
    The black sauce comes from keluak fruit. 
  ...
  },
  {
    id: "rujak_cingur",
    title: "Rujak Cingur",
    description: `Rujak cingur is a famous East Java specialty, originating from the Surabaya area. 
  ...
  },
  {
    ...
    description: `Clover is a creeper that is easily found around rice fields and the banks of irrigation channels. 
  ...
  },
  {
    ...
    description: `Kupang is a small sea shell commonly found on the coast. 
    In the East Java region, this animal can be processed into delicious dishes, you know. 
  ...
  },
  {
    id: "nasi_bebek",
    title: "Nasi Bebek",
    description: `Duck meat can be very delicious when processed into this typical East Java duck rice dish. 
  ...
  },
  {
    id: "bakwan_malang",
    title: "Bakwan Malang",
    description: `As the name implies, this food comes from the Malang region of East Java. 
  ...
  },
  {
    id: "tahu_campur",
    title: "Tahu Campur",
    description: `Another East Java specialty made from tofu is mixed tofu. 
  ...
  },
  {
    id: "rujak_soto",
    title: "Rujak Soto",
    description: `It is called rujak soto because this dish is a combination of soto soup and some typical rujak cingur fillings, namely petis and pisang batu. 
